...
As you can see, a number of gods do not have data about their parents in the format we are scraping. We are excluding them from the results and we now have a list of tuples. Here are the first 5 tuples:
