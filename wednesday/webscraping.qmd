...
As you can see, a number of gods (their names printed) do not have parents. Also, some `requests.get()` calls
return 404, so we process only those that return 200.
