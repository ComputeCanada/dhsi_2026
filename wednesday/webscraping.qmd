...
allows you to send commands to a web server. In our case, we use it to get the HTML of the page we are interested in.

makes it easy to pull data out of HTML files.

is the DataFrame library that we will use to store our data.
