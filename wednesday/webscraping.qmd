...
I don't know why I am getting this error message. The code obviously works and is correct, so let's just ignore it.

:::

We now have a list of tuples with our results. Here are the first 5 tuples:
...
A DataFrame would be a lot more convenient than a list of tuples to hold our results. Let's create one with Polars:
