...
[requests](https://github.com/psf/requests) allows you to send commands to a web server. In our case, we use it to get the HTML of the page we are interested in while [beautifulsoup4](https://www.crummy.com/software/BeautifulSoup/bs4/doc/) makes it easy to pull data out of HTML files.
